...
export function Birds() {
  return (
    <>
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-10 text-brand-primary overflow-hidden">
        {/* Flying Bird Right (Flies Left) */}
        <motion.div 
          className="absolute w-[6.9%] min-[1920px]:w-[133.07px] h-auto min-[1920px]:h-[73.74px] top-[74%] min-[1920px]:top-[798px] right-[-10%] min-[1920px]:right-auto min-[1920px]:left-[2160px] opacity-100"
          {...ANIMATIONS.flyRight}
        >
        ...
        <motion.div 
          className="absolute w-[6.9%] min-[1920px]:w-[133.07px] h-auto min-[1920px]:h-[73.74px] top-[60%] min-[1920px]:top-[649.2px] left-[-10%] min-[1920px]:left-[-240px] opacity-100"
          {...ANIMATIONS.flyLeft}
        >
          <BirdFlying />
        </motion.div>
